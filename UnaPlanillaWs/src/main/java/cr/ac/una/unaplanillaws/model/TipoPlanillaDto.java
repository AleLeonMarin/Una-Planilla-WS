 ...
 * @author cbcar
 */
@Schema(description = "Esta clase contiene la información de un tipo de planilla")
public class TipoPlanillaDto {
    @Schema(description = "Identificador del tipo de planilla", example = "1")
    private Long id;
    @Schema(description = "Código del tipo de planilla", example = "1")
    public String codigo;
    @Schema(description = "Descripción del tipo de planilla", example = "Planilla de empleados")
    public String descripcion;
    @Schema(description = "Cantidad de planillas por mes", example = "1")
    public Integer planillaPorMes;
    @Schema(description = "Año de la última planilla", example = "2021")
    private Integer anoUltimaPlanilla;
    @Schema(description = "Mes de la última planilla", example = "9")
    private Integer mesUltimaPlanilla;
    @Schema(description = "Número de la última planilla", example = "1")
    private Integer numeroUltimaPlanilla;
    @Schema(description = "Estado del tipo de planilla", example = "A")
    public String estado;
    @Schema(description = "Versión del registro", example = "1")
    private Long version;
    @Schema(description = "Modificado", example = "false")
    private Boolean modificado;
    @Schema(description = "Lista de empleados del tipo de planilla")
